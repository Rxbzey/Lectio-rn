...
export const NumberGridModal: React.FC<NumberGridModalProps> = ({
  visible,
  title,
  subtitle,
  count,
  ...
  return (
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <View className="flex-1" style={{ backgroundColor: bgColor, paddingTop: insets.top, paddingBottom: insets.bottom }}>
        {/* Header */}
        <View className="px-6 pt-4 pb-6 flex-row justify-between items-start">
          ...
          <Pressable className="p-2 mt-1" onPress={onClose} hitSlop={12}>
            <MaterialIcons name="close" size={28} color={mutedText as string} />
          </Pressable>
        </View>

        {/* Back link */}
        <Pressable className="px-6 py-3 flex-row items-center gap-2" onPress={onClose}>
